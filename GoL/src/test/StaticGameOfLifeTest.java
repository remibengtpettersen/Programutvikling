...
public class StaticGameOfLifeTest {
    ...
    @Test
    public void testAggregateNeighbours_ifTwoAlive_thenReturnTwoNeighbours() throws Exception {
        // instantiate gol
        ...
        // aggregate neighbours - column 0 to 2
        gol.aggregateNeighbours(0, 4);

        // assert equal
        assertEquals(2, gol.getNeighboursAt(1, 2));
    }

    @Test
    public void testAggregateNeighbours_ifThreeAlive_thenReturnThreeNeighbours() throws Exception {
        // instantiate gol
        ...
        // assert equal
        assertEquals(3, gol.getNeighboursAt(2, 2));
    }

    @Test
    public void testAggregateNeighbours_ifFourAlive_thenReturnFourNeighbours() throws Exception {
        // instantiate gol
        gol = new StaticGameOfLife(5, 5);
        ...
        // assert equal
        assertEquals(4, gol.getNeighboursAt(2, 2));
    }

    @Test
    public void testAggregateNeighbours_ifFiveAlive_thenReturnFiveNeighbours() throws Exception {
        // instantiate gol
        gol = new StaticGameOfLife(5, 5);
        ...
        // assert equal
        assertEquals(5, gol.getNeighboursAt(2, 2));
    }

    @Test
    public void testAggregateNeighbours_ifSixAlive_thenReturnSixNeighbours() throws Exception {
        // instantiate gol
        gol = new StaticGameOfLife(5, 5);
        ...
        // assert equal
        assertEquals(6, gol.getNeighboursAt(2, 2));
    }

    @Test
    public void testAggregateNeighbours_ifSevenAlive_thenReturnSevenNeighbours() throws Exception {
        // instantiate gol
        gol = new StaticGameOfLife(5, 5);
        ...
        // assert equal
        assertEquals(7, gol.getNeighboursAt(2, 2));
    }

    @Test
    public void testAggregateNeighbours_ifEightAlive_thenReturnEightNeighbours() throws Exception {
        // instantiate gol
        gol = new StaticGameOfLife(5, 5);
        ...
        // assert equal
        assertEquals(8, gol.getNeighboursAt(2, 2));
    }
    ...
    public void testResetNeighboursAt_ifAlive_thenReturnZero() {
        ...
        gol.aggregateNeighbours(0, 5);

        // assert neighbours
        assertEquals(1, gol.getNeighboursAt(2, 2));
